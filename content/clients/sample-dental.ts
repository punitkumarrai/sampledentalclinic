...
const sampleDental: SiteConfig = {
  presetId: "sample-dental",
  ...
  business: {
    ...
    email: "hello@sampledentalclinic.com",
  ...
  metadata: {
    ...
    about: {
      ...
      description:
        "Learn why families in Greater Noida trust Sample Dental Clinic for modern, comfortable, and expert dental care.",
    },
    services: {
    ...
    contact: {
      ...
      description:
        "Get in touch with Sample Dental Clinic in Alpha 2 Main Market, Greater Noida. Call +91 88511 69748 or message us on WhatsApp.",
    },
  },
  ...
  hero: {
    ...
    headingSuffix: " Care",
    description:
      "At Sample Dental Clinic, we combine modern technology with a warm, family-friendly approach. From routine cleanings to advanced treatments — your comfort always comes first.",
  ...
  doctor: {
    ...
    imageAlt: "Dr. Arjun Mehta — Lead Dentist at Sample Dental Clinic",
  },
  ...
  aboutPage: {
    ...
    heroDescription:
      "At Sample Dental Clinic, we believe dentistry shouldn\u2019t feel intimidating. We\u2019ve built a practice rooted in transparency, advanced hygiene protocols, and a genuine commitment to your comfort.",
    ...
    storyImageAlt:
      "Modern, clean, and welcoming reception area at Sample Dental Clinic",
  ...
  gallery: [
    {
      ...
      alt: "Modern, welcoming reception area at Sample Dental Clinic",
    },
    {
  ...
  email: {
    ...
    senderName: "Sample Dental Clinic",
    recipientEmail: "thenewstar0808@gmail.com",
  },
};

export default sampleDental;
