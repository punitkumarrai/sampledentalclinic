...
const dentalClinicTemplate: SiteConfig = {
  presetId: "dental-clinic-template",
  ...
  metadata: {
    home: {
      title: "[Your Clinic Name] — Premium Dental Care in [City]",
      description:
        "Trusted dental clinic in [City]. Gentle, modern care for the whole family — teeth cleaning, braces, implants, root canal & more. Book your appointment today.",
      keywords: [
        "dentist [city]",
        "dental clinic [area]",
        "teeth cleaning",
    ...
    about: {
      title: "About Us | [Your Clinic Name]",
      description:
        "Learn why families in [City] trust [Your Clinic Name] for modern, comfortable, and expert dental care.",
    },
    services: {
      title: "Services | [Your Clinic Name]",
      description:
        "Comprehensive dental care in [City]: Teeth Cleaning, Root Canals, Aligners, Implants, and Kids Dentistry.",
    },
    contact: {
      title: "Contact Us | [Your Clinic Name]",
      description:
        "Get in touch with [Your Clinic Name]. Call or message us on WhatsApp to book your appointment.",
    },
  },

  // ── Hero ──────────────────────────────────────────────────────────
  hero: {
    tagline: "Trusted Dental Care in [City]",
    heading: "Your Smile Deserves ",
    headingAccent: "Gentle,\u00a0Expert",
    headingSuffix: " Care",
    description:
      "At [Your Clinic Name], we combine modern technology with a warm, family-friendly approach. From routine cleanings to advanced treatments — your comfort always comes first.",
  ...
  doctor: {
    ...
    bio: "Dr. [Last Name] believes that every patient deserves a dental experience that\u2019s comfortable, clear, and respectful. Their approach combines technical expertise with a warm, patient-first philosophy.",
    quote:
    ...
    imageAlt: "Dr. [Full Name] — Lead Dentist at [Your Clinic Name]",
  },
  ...
  testimonials: [
    {
      name: "[Patient Name 1]",
      text: "The team was incredibly professional and made me feel completely at ease throughout my treatment. Highly recommend!",
      treatment: "Root Canal",
      stars: 5,
    },
    {
      name: "[Patient Name 2]",
      text: "Brought my child for their first dental visit. The staff was so gentle and patient. A wonderful experience!",
      treatment: "Kids Dentistry",
      stars: 5,
    },
    {
      name: "[Patient Name 3]",
      text: "Got my aligners here. Everything was explained clearly and the pricing was completely transparent. Very happy with the results.",
      treatment: "Aligners",
      stars: 5,
    },
  ],
  ...
  faqs: [
    {
      ...
      answer:
        "While we do accept walk-ins for dental emergencies, we highly recommend booking an appointment to ensure you don\u2019t have to wait.",
    },
    {
      question: "Is root canal treatment painful?",
      answer:
        "Not at all. With modern anesthetics and advanced techniques, a root canal feels no different than getting a standard filling.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Absolutely. We offer traditional metal and ceramic braces as well as clear, invisible aligners for both teens and adults.",
    },
    {
  ...
  aboutPage: {
    ...
    heroDescription:
      "At [Your Clinic Name], we believe dentistry shouldn\u2019t feel intimidating. We\u2019ve built a practice rooted in transparency, advanced hygiene protocols, and a genuine commitment to your comfort.",
    storyHeading: "Rooted in [City].\nDriven by Excellence.",
    storyParagraphs: [
      "When we first opened our doors, we had one simple goal: to change how people genuinely feel about going to the dentist.",
      "Today, we are incredibly proud to be the trusted dental home for hundreds of local families. From toddlers to grandparents, our team is equipped to handle every generation under one roof.",
    ...
    storyImageAlt:
      "Modern, clean, and welcoming reception area at the clinic",
  ...
  bookPage: {
    ...
    sidebarDescription:
      "Requesting an appointment is completely stress-free. We will swiftly review your preferences and personally call you to confirm your slot.",
  ...
  // ── Gallery ───────────────────────────────────────────────────────
  gallery: [
    { src: "/images/reception.jpg", alt: "Modern, welcoming reception area" },
    { src: "/images/treatment.jpg", alt: "State-of-the-art treatment room" },
    { src: "/images/tools.jpg", alt: "Sterilized dental equipment" },
    { src: "/images/consultation-room.jpg", alt: "Comfortable consultation room" },
  ],
  ...
  footer: {
    tagline:
      "Your family\u2019s trusted dental care partner. Modern treatments, gentle hands, and sincere smiles in a spotless environment.",
    servicesList: [
  ...
  email: {
    ...
    senderName: "[Your Clinic Name]",
    recipientEmail: "thenewstar0808@gmail.com",
  },
};

export default dentalClinicTemplate;
