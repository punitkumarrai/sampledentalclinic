...
const cityLight: SiteConfig = {
  ...
  hero: {
    ...
    headingSuffix: " Care",
    description:
      "At City Light Dental Care, we combine modern technology with a warm, family-friendly approach. From routine cleanings to advanced treatments — your comfort always comes first.",
  ...
  gallery: [
    {
      ...
      alt: "Modern, welcoming reception area at City Light Dental Care",
    },
    {
